...
MainWindow::MainWindow(QWidget *parent) :
    QMainWindow(parent)
{    m_pForm_menu = new Formmenu();
    m_pForm_menu->show();
    m_pForminstruction = new Forminstruction();
    m_pchoujiang = new choujiang();
    m_pfenshu = new choujiang();
    QObject::connect(m_pForm_menu,&Formmenu::emit_game,this,&MainWindow::slots_game);
    QObject::connect(m_pForm_menu,&Formmenu::emit_ins,m_pForminstruction,&Forminstruction::slots_int);
    QObject::connect(this,&MainWindow::emit_choujiang,m_pchoujiang,&choujiang::slots_choujiang);
    QObject::connect(m_pchoujiang,&choujiang::emit_regame,this,&MainWindow::slots_regame);
    QObject::connect(this,&MainWindow::updateAB,m_pfenshu,&choujiang::onUpdateAB);

    Q_PROPERTY(int myVariable READ getMyVariable WRITE setMyVariable);
    ...
    QPushButton* btn = new QPushButton("商店",this);
    btn->resize(55,25);
    btn->setParent(this);
   btn->move(320,10);
    btn->show();
   ...
   connect(btn, &QPushButton::clicked, [=]()
 {
    ...
    this->setWindowTitle("FlappyBird");		///设置标题
}
...
void MainWindow::slots_game()
{
    this->show();

}

void MainWindow::slots_regame()
{
    this->show();
