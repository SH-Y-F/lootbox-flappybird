    ...
    if(QPos::Fcoin>=0)
{
    ...
    if(imageList.at(index)== ":/Images/S1.png")
    {
        XXX++;
        emit emit_pingfen1();
    }
    else if(imageList.at(index)==":/Images/S3.png")
    {
        XXX++;
        emit emit_pingfen2();
    }
    else if(imageList.at(index)==":/Images/S4.png")
    {
        XXX++;
        emit emit_pingfen3();
    }
    else if(imageList.at(index)==":/Images/A8.png")
    {
        emit emit_pingfen4();
    }
    else if(imageList.at(index)==":/Images/A20.png")
    {
        emit emit_pingfen5();
    }
    else if(imageList.at(index)==":/Images/A32.png")
    {
        emit emit_pingfen6();
    }
    else if(imageList.at(index)==":/Images/A44.png")
    {
        emit emit_pingfen7();
    }
    else if(imageList.at(index)==":/Images/A56.png")
    {
        emit emit_pingfen8();
    }
    else if(imageList.at(index)==":/Images/A68.png")
    {
        emit emit_pingfen9();
    }
    else if(imageList.at(index)==":/Images/A80.png")
    {
        emit emit_pingfen10();
    }
